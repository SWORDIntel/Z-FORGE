#!/bin/bash
# Download packages from Debian snapshots with correct paths - WORKING VERSION
# Uses snapshot.debian.org which archives all Debian packages

set -e

echo "═══════════════════════════════════════════════════════════════════"
echo "        Downloading Packages from Debian Snapshots (Working)"
echo "═══════════════════════════════════════════════════════════════════"

PACKAGE_DIR="/opt/github/Z-FORGE/snapshot_packages_working"
mkdir -p "$PACKAGE_DIR"
cd "$PACKAGE_DIR"
