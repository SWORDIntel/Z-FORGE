...
sudo bash -c 'cat >> ${CHROOT_PATH:-/home/john/zforge_workspace/chroot}/etc/hosts << EOF
...
sudo chroot ${CHROOT_PATH:-/home/john/zforge_workspace/chroot} /bin/bash -c 'ping -c 1 deb.debian.org' && echo "✓ DNS working" || echo "✗ DNS still not working"
