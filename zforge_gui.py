...
class ZForgeGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("Z-FORGE Build System GUI v1.0")
    ...
    def setup_build_selection(self):
        ...
        # Title
        title_label = ttk.Label(self.build_frame, text="Select Build Type", font=('Arial', 14, 'bold'))
        title_label.pack(pady=(10, 20))
        
        # Build type selection
        self.selected_build = tk.StringVar(value="Stable Build (Recommended)")
    ...
    def setup_configuration(self):
        ...
        # Title
        title_label = ttk.Label(self.config_frame, text="Build Configuration", font=('Arial', 14, 'bold'))
        title_label.pack(pady=(10, 20))
    ...
    def setup_performance_config(self, parent):
        ...
        self.workspace_var = tk.StringVar(value=os.path.expanduser("~/zforge_workspace"))
    ...
    def on_build_selection_change(self):
        ...
        if "Outside Packages" in selected or "Stable" in selected:
            # Faster builds can use more cores
            self.jobs_var.set(min(8, self.cpu_count))
        else:
            # More complex builds should be conservative
